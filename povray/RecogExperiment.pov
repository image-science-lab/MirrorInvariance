...
//#declare poseSelect = floor((frame_number-1)*10/final_frame);            //USE THIS LINE INSTEAD OF NEXT WHEN USING SCRIPT
#declare poseSelect = 0;   

                            


#declare xPose=seed(poseSelect*10000);
...
#write(MyFile1, poseSelect, " ", frame_number , " ", poses[0][0], " ",  poses[0][1], " ",  poses[0][2], " ",  poses[0][3], " ",  poses[0][4], "\n")
#fclose MyFile1
#fopen MyFile2 "RecogSurf2_Poses.txt" append
#write(MyFile2, poseSelect, " ", frame_number , " ", poses[1][0], " ",  poses[1][1], " ",  poses[1][2], " ",  poses[1][3], " ",  poses[1][4], "\n")
#fclose MyFile2
#fopen MyFile3 "RecogSurf3_Poses.txt" append
#write(MyFile3, poseSelect, " ", frame_number , " ", poses[2][0], " ",  poses[2][1], " ",  poses[2][2], " ",  poses[2][3], " ",  poses[2][4], "\n")
#fclose MyFile3                                                                                
#fopen MyFile4 "RecogSurf4_Poses.txt" append
#write(MyFile4, poseSelect, " ", frame_number , " ", poses[3][0], " ",  poses[3][1], " ",  poses[3][2], " ",  poses[3][3], " ",  poses[3][4], "\n")
#fclose MyFile4
