...
//#declare poseSelect = floor((frame_number-1)*30/final_frame);          //Use this instead of the next line when running with script
...
sky_sphere {
        pigment {
               image_map {
         //               hdr "grace-new.hdr"
                         jpeg     "pebbles_9290205.jpg"        //CHANGE TO OTHER ENVIRONMENT MAPS HERE
                       map_type 1
                       interpolate 2
                       }
