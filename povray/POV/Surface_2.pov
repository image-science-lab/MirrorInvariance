...
//#declare poseSelect = floor(frame_number*30/final_frame);     //USE THIS INSTEAD OF THE NEXT LINE WHEN RUNNING FROM SCRIPT
#declare poseSelect = 0;


#fopen MyFile "Surface2_Sanity.txt" append
